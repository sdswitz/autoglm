...
sba <- sba %>% mutate(
  ...
  TermBucket = cut(Term, breaks = c(0, 12, 24, 36, 48, 60, 72, 84, 96, 120, 180, 240, 360, Inf),
                   labels = c("0-1yr", "1-2yr", "2-3yr", "3-4yr", "4-5yr", "5-6yr", "6-7yr", "7-8yr", "8-10yr", "10-15yr", "15-20yr", "20-30yr", "30yr+"),
                   include.lowest = TRUE)
)
